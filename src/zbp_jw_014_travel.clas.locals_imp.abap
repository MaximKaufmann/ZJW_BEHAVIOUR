...
PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zjw_014_travel.
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY zjw_014_travel FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
  ...
  METHOD validate_agency.
    ...
    READ ENTITY zjw_014_travel\\travel FROM VALUE #(
  ...
  METHOD calculatetravelkey.
    READ ENTITIES OF zjw_014_travel IN LOCAL MODE
        ENTITY Travel
          FIELDS ( travel_id )
    ...
    "Get max travelID
    SELECT SINGLE FROM zjw_travel_014 FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).

    "update involved instances
    MODIFY ENTITIES OF zjw_014_travel IN LOCAL MODE
      ENTITY Travel
