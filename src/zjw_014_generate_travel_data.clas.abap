CLASS zjw_014_generate_travel_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zjw_014_generate_travel_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF zjw_travel_014.

* fill internal travel table (itab)
    itab = VALUE #( ( mykey = '02D5290E594C1EDA93815057FD946624'
    travel_id = '00000022'
    agency_id = '00000310'
    customer_id = '00000700'
    begin_date = '20220624'
    end_date = '20220628'
    booking_fee = '60.00'
    total_price = '750.00'
    currency_code = 'USD'
    description = 'traveling with dog'
    overall_status = 'O'
    created_by = 'MUSTERMANN'
    created_at = '20220612133945.5960060'
    last_changed_by = 'MUSTERFRAU'
    last_changed_at =    '20220702105400.3647680' )
...
* delete existing entries in the database table
    DELETE FROM zjw_travel_014.
    out->write( |Removed { sy-dbcnt } entries from travel table.| ).

* insert the new table entries
    INSERT zjw_travel_014 FROM TABLE @itab.
